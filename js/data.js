window.portfolioData = {
    ...
    zh: {
        personal: {
            name: "王玥",
            title: "AI 工程师 / 研究者",
            bio: "我目前在华为担任工程师，主要从事基于昇腾硬件的推理引擎开发和模型性能调优工作。我毕业于上海交通大学人工智能专业，并获得硕士学位。我的研究兴趣主要集中在多模态学习与参数高效微调。在相关领域发表了多篇顶级AI会议论文，累计被引用达365次（h-index: 5）。我致力于探索和设计更高效、更具硬件亲和性且泛化能力卓越的基础模型与智能体系统。",
